...
public final class FingerprintModule$$ModuleAdapter extends ModuleAdapter<FingerprintModule> {
  private static final String[] INJECTS = { "members/haseley.abby.info_security_password_creator_and_manager.LogIn", };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { };

  public FingerprintModule$$ModuleAdapter() {
    super(haseley.abby.info_security_password_creator_and_manager.FingerprintModule.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, true /*library*/);
  }
  ...
  public void getBindings(BindingsGroup bindings, FingerprintModule module) {
    ...
    bindings.contributeProvidesBinding("javax.crypto.KeyGenerator", new ProvidesKeyGeneratorProvidesAdapter(module));
    bindings.contributeProvidesBinding("javax.crypto.Cipher", new ProvidesCipherProvidesAdapter(module));
  ...
  public static final class ProvidesContextProvidesAdapter extends ProvidesBinding<android.content.Context>
    ...
    public ProvidesContextProvidesAdapter(FingerprintModule module) {
      super("android.content.Context", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesContext");
      this.module = module;
      setLibrary(true);
    }
  ...
  public static final class ProvidesFingerprintManagerProvidesAdapter extends ProvidesBinding<android.hardware.fingerprint.FingerprintManager>
    ...
    public ProvidesFingerprintManagerProvidesAdapter(FingerprintModule module) {
      super("android.hardware.fingerprint.FingerprintManager", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesFingerprintManager");
      this.module = module;
      setLibrary(true);
    }
  ...
  public static final class ProvidesKeyguardManagerProvidesAdapter extends ProvidesBinding<android.app.KeyguardManager>
    ...
    public ProvidesKeyguardManagerProvidesAdapter(FingerprintModule module) {
      super("android.app.KeyguardManager", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesKeyguardManager");
      this.module = module;
      setLibrary(true);
    }
  ...
  public static final class ProvidesKeystoreProvidesAdapter extends ProvidesBinding<java.security.KeyStore>
    ...
    public ProvidesKeystoreProvidesAdapter(FingerprintModule module) {
      super("java.security.KeyStore", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesKeystore");
      this.module = module;
      setLibrary(true);
    }
  ...
  /**
   * A {@code Binding<javax.crypto.KeyGenerator>} implementation which satisfies
   * Dagger's infrastructure requirements including:
   *
   * Being a {@code Provider<javax.crypto.KeyGenerator>} and handling creation and
   * preparation of object instances.
   */
  public static final class ProvidesKeyGeneratorProvidesAdapter extends ProvidesBinding<javax.crypto.KeyGenerator>
      implements Provider<javax.crypto.KeyGenerator> {
    private final FingerprintModule module;

    public ProvidesKeyGeneratorProvidesAdapter(FingerprintModule module) {
      super("javax.crypto.KeyGenerator", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesKeyGenerator");
      this.module = module;
      setLibrary(true);
    }
    ...
    /**
     * Returns the fully provisioned instance satisfying the contract for
     * {@code Provider<javax.crypto.KeyGenerator>}.
     */
    @Override
    public javax.crypto.KeyGenerator get() {
      return module.providesKeyGenerator();
    }
  }
   ...
   * Dagger's infrastructure requirements including:
   *
   * Owning the dependency links between {@code javax.crypto.Cipher} and its
   * dependencies.
   *
   * Being a {@code Provider<javax.crypto.Cipher>} and handling creation and
   * preparation of object instances.
   */
  public static final class ProvidesCipherProvidesAdapter extends ProvidesBinding<javax.crypto.Cipher>
      implements Provider<javax.crypto.Cipher> {
    private final FingerprintModule module;
    private Binding<java.security.KeyStore> keyStore;

    public ProvidesCipherProvidesAdapter(FingerprintModule module) {
      super("javax.crypto.Cipher", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesCipher");
      this.module = module;
      setLibrary(true);
    }
    ...
    public javax.crypto.Cipher get() {
      return module.providesCipher(keyStore.get());
    }
  }
  ...
  public static final class ProvidesInputMethodManagerProvidesAdapter extends ProvidesBinding<android.view.inputmethod.InputMethodManager>
    ...
    public ProvidesInputMethodManagerProvidesAdapter(FingerprintModule module) {
      super("android.view.inputmethod.InputMethodManager", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesInputMethodManager");
      this.module = module;
      setLibrary(true);
    }
  ...
  public static final class ProvidesSharedPreferencesProvidesAdapter extends ProvidesBinding<android.content.SharedPreferences>
    ...
    public ProvidesSharedPreferencesProvidesAdapter(FingerprintModule module) {
      super("android.content.SharedPreferences", NOT_SINGLETON, "haseley.abby.info_security_password_creator_and_manager.FingerprintModule", "providesSharedPreferences");
      this.module = module;
      setLibrary(true);
    }
